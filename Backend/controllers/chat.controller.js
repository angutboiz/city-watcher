    ...
    try {
        ...
        if (
            ...
            return res
                ...
                .json({
                    message:
                        'Vui lòng cung cấp thông tin người tham gia hợp lệ',
                })
        }
...
const Update = async (req, res) => {
    try {
        ...
        if (!updatedChat) {
            return res
                .status(404)
                .json({ message: 'Không tìm thấy cuộc trò chuyện để cập nhật' })
        }
...
const Delete = async (req, res) => {
    try {
        ...
        if (!deletedChat) {
            return res
                .status(404)
                .json({ message: 'Không tìm thấy cuộc trò chuyện để xóa' })
        }
