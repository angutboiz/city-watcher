            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div>
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                        <div>
                            <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Tên đầy đủ</p>
                            <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.displayName || "Chưa có đặt tên"}</p>
                        </div>

                        <div>
                            <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Địa chỉ Email</p>
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.phoneNumber || "Chưa có sđt"}</p>
                        </div>

                        <div>
                            <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Chức vụ</p>
                            <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.roles}</p>
                        </div>
                    </div>
                </div>
